...
#python Descarga_VIIRS_diarios.py --year_from 2022 --year_to 2022 --photometers /mnt/data/datos_borja/Todos_fotometros.csv --out /mnt/data/datos_borja/VIIRS/Diarios
...
def Nombre(ano,dia):
    dia=dia_format(dia)
    csv=pd.read_csv('https://ladsweb.modaps.eosdis.nasa.gov/archive/allData/5000/VNP46A1/'+str(ano)+'/'+dia+'.csv')
...
def Descarga(ano,dia):
    ...
    url='https://ladsweb.modaps.eosdis.nasa.gov/archive/allData/5000/VNP46A1/'+str(ano)+'/'+dia_format(dia) 
